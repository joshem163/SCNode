...
from torch_geometric.nn import GCNConv, SAGEConv, GATConv, LINKX
...
class LinkX(torch.nn.Module):
    def __init__(self, num_nodes, in_channels, hidden_channels, out_channels, num_layers,
        ...
        self.convs = torch.nn.ModuleList()
        self.convs.append(LINKX(num_nodes,in_channels, hidden_channels,out_channels,num_layers,dropout))
